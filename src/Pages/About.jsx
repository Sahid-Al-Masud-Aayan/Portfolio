...
const About = () => {
  ...
  return (
    ...
    <div className="w-[450px] md:h-[1200px] md:w-[1000px] bg-gradient-to-r from-[#c2e59c] to-[#64b3f4] rounded-3xl text-center gap-2 p-6 md:p-4 mt-[60px] mb-[60px]">
      ...
      <div data-aos="fade-up"><img src="./public/pfp2.png" className='w-[250px] h-[300px] md:w-[280px] md:h-[400px] rounded-xl ml-[76px] mb-6 md:ml-0 md:mb-0 md:rounded-3xl' alt="My Image" /></div>
      ...
      <div data-aos="fade-left"><h2 className='text-[24px] md:text-[30px] mt-7 font-subHed font-semibold text-[#063c7d]'>What I Offer</h2></div>
