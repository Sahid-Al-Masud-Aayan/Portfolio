...
{/* <div className="container">
  ...
  <div className="container">
    ...
    <div data-aos="fade-up">
    <div className="h-[900px] md:h-[600px] md:w-[1100px] w-[400px] bg-gradient-to-r from-[#7e7e7e] to-[#f3f3f3] rounded-2xl gap-2 p-5 mt-[60px] mb-[60px] md:mt-0 md:mb-0">
    <div data-aos="fade-left">
      ...
      <div className="flex flex-col md:justify-start md:items-start justify-center items-center">
       ...
       <div data-aos="fade-left">
  <h1 className="md:text-[82px] text-[52px] mt-2 text-center md:text-start font-latoNav leading-tight text-white font-semibold text-animation">
    Sahid Al <br /> Masud Aayan
  </h1>
</div>
  ...
  <span class="absolute w-full h-full bg-green-600 -right-56 top-0 -rotate-45 group-hover:rotate-0 group-hover:right-0 duration-500"></span>
      ...
      <div className="absolute md:w-[300px] md:h-[380px] bg-[#ff8800] md:left-[650px] md:top-[23.5%] rounded-full "></div>
      <div className="absolute md:w-[300px] md:h-[380px] bg-[#ff00f7] md:left-[720px] md:top-[23.5%] rounded-full "></div>
      <div className="absolute md:w-[300px] md:h-[380px] bg-[#0400ff] md:left-[690px] md:top-[22.5%] rounded-full "></div>
