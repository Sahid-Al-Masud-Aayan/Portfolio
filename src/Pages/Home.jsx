...
{/* <div className="container">
  ...
  <div className="container">
    <div className="flex justify-center items-center min-h-screen ">
    <div data-aos="fade-up">
    <div className="h-[800px] md:h-[600px] md:w-[1100px] w-[400px] bg-gradient-to-r from-[#7e7e7e] to-[#f3f3f3] rounded-2xl gap-2 p-5">
    <div data-aos="fade-left">
      ...
      <div className=" md:flex justify-center md:gap-20 gap-1 items-center mt-6">
      <div className="flex flex-col justify-start items-start ">
        
       <div data-aos="fade-left">
  <h1 className="md:text-[82px] text-[52px] mt-2 font-latoNav leading-tight text-white font-semibold text-animation">
    Sahid Al <br /> Masud Aayan
  </h1>
</div>
    ...
    <div data-aos="fade-down"><p className=' md:text-[14px] text-[12px] font-slab text-[#000000]'>I'm Aayan, a skilled React developer<br/>  with extensive experience in building <br/> dynamic and responsive web applications.</p></div>
      <div data-aos="zoom-in">
      <a class="cursor-pointer overflow-hidden relative z-100 flex justify-center items-center gap-3 bg-yellow-500 group py-2 px-5 md:px-14 md:py-3 mt-5 md:mt-10 md:ml-[115px] ml-0 rounded-full tracking-wide font-nav" download="Aayan's CV" href="cv1.pdf">
