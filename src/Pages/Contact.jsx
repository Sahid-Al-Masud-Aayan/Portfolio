...
<div data-aos="zoom-in-up">
     ...
     <div class="absolute right-20 -top-4  group-hover:top-[10px] group-hover:right-2 z-10 w-40 h-40 rounded-full group-hover:scale-150 duration-500 bg-sky-900"></div>
     <div class="absolute -right-5 -top-4  group-hover:top-1 group-hover:right-2 z-10 w-32 h-32 rounded-full group-hover:scale-150  duration-500 bg-teal-700"></div>
     <div class="absolute right-[20rem] top-[8rem] group-hover:top-1 group-hover:right-2 z-10 w-20 h-20 rounded-full group-hover:scale-150  duration-500 bg-blue-600"></div>
     <div class="absolute right-[5em] -top-4 group-hover:top-1 group-hover:right-2 z-10 w-16 h-16 rounded-full group-hover:scale-150  duration-500 bg-sky-600"></div>
     ...
     <a className='group-hover:underline font-merri text-[10px] md:text-[16px]' href="mailto:aayan.webdeveloper@gmail.com">aayan.webdeveloper@gmail.com</a>
      ...
      <div class=" hover:scale-95 duration-300 relative group text-sky-100  overflow-hidden w-96 h-44 rounded-md bg-orange-300 p-2 flex justify-center items-center font-extrabold shadow-xl">

     <div class="absolute right-20 -top-4  group-hover:top-[10px] group-hover:right-2 z-10 w-40 h-40 rounded-full group-hover:scale-150 duration-500 bg-[#ffb732]"></div>
     <div class="absolute -right-5 -top-4  group-hover:top-1 group-hover:right-2 z-10 w-32 h-32 rounded-full group-hover:scale-150  duration-500 bg-[#EC4899]"></div>
     <div class="absolute right-[20rem] top-[8rem] group-hover:top-1 group-hover:right-2 z-10 w-20 h-20 rounded-full group-hover:scale-150  duration-500 bg-[#F97316]"></div>
     <div class="absolute right-[5em] -top-4 group-hover:top-1 group-hover:right-2 z-10 w-16 h-16 rounded-full group-hover:scale-150  duration-500 bg-[#f00d0d]"></div>
     <div className="flex flex-col justify-center items-center z-10">
